...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var S = {
			...
			error: { margin: 0, fontSize: 12, color: 'var(--dsw-alias-label-error, #e5484d)' },
			ok: { margin: 0, fontSize: 12, color: '#5dbb76' },
			...
			badgeErr: { whiteSpace: 'nowrap', background: 'rgba(229, 72, 77, 0.15)', color: '#e5484d', borderRadius: 999, padding: '1px 8px', fontSize: 11, lineHeight: '17px' },
			button: {
				font: 'inherit',
				cursor: 'pointer',
				background: 'var(--dsw-alias-bg-module-platform, #20242c)',
